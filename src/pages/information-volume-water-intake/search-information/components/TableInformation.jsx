                        ...
                        <Table aria-label="Таблица">
                            <TableHead>
                                <TableRow>
                                    ...
                                    <TableCell size="small" align="center" sx={{border: 1}}>Цель
                                        водопользования</TableCell>
                                    <TableCell size="small" align="center" sx={{border: 1}}>Объем допустимого забора,
                                        тыс. м3</TableCell>
                                    <TableCell size="small" align="center" sx={{border: 1}}>Объем фактического забора,
                                        тыс. м3</TableCell>
                                </TableRow>
                                <TableRow
                                    sx={{'&:last-child td, &:last-child th': {border: 1, rowSpan: 1}}}
