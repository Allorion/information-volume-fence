...
const FormEditDetailInformation = (props) => {
    ...
    // Создаем локальный стейт для хранения данных из глобального стейта
...
export default React.memo(FormEditDetailInformation);