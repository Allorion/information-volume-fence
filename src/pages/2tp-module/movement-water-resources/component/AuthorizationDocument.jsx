...
const AuthorizationDocument = () => {
    ...
    const typeDocument = useInput('null');
    const numberDocument = useInput('');
    const dateDocument = useInputDate(new Date());
    const codeGuivProvider = useInput('', {isSymbolGuiv: true})
