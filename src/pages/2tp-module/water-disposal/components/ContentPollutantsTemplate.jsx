...
//
//
// export default function ContentPollutantsTemplate() {
//
//     // Получаем данные из родительского компонента
//     const [contentPollutantsField,
//         contentPollutantsFlag,
//         contentPollutantsComponents] = useContext(ContentPollutantsContext);
//
//     // Стейт со списками форм
//     const [arrayContentPollutants,
//         setArrayContentPollutants] = useState(contentPollutantsComponents.current);
...
//         <React.Fragment>
//             <Paper elevation={3}>
//                 <HeadBox>Содержание загрязняющих веществ (масса ЗВ) в отведенных водах по кодам загрязняющих веществ
//                     (коды ЗВ)</HeadBox>
//                 <Box p={4}>
//                     <Grid container spacing={2} justifyContent='center' alignContent='center'>
//                         <Fab
